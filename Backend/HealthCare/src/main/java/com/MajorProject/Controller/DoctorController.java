...
public ResponseEntity<String> AddDoctorProfile(
    ...
    public ResponseEntity<?> findDoctors(
        ...
        // Sanitize "null" string or empty strings to actual null
        name = (name == null || name.trim().isEmpty() || "null".equalsIgnoreCase(name.trim())) ? null : name.trim();
        city = (city == null || city.trim().isEmpty() || "null".equalsIgnoreCase(city.trim())) ? null : city.trim();
        speciality = (speciality == null || speciality.trim().isEmpty() || "null".equalsIgnoreCase(speciality.trim())) ? null : speciality.trim();
